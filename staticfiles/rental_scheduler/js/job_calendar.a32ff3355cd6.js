        ...
        openEventDetailsDialog(info) {
            try {
                ...
                if (jobId) {
                    ...
                    tempElement.setAttribute('hx-get', `/jobs/${jobId}/detail/`);
                    tempElement.setAttribute('hx-trigger', 'load');
                    tempElement.setAttribute('hx-target', 'body');
                    tempElement.setAttribute('hx-swap', 'beforeend');
                    
                    // Trigger the HTMX request
                    if (typeof htmx !== 'undefined') {
                        htmx.trigger(tempElement, 'load');
                    } else {
                        ...
                        fetch(`/jobs/${jobId}/detail/`)
                            ...
                            .catch(error => {
                                console.error('Error loading job modal:', error);
                            });
                    }
                } else {
